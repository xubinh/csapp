...
- <a href="#6.3">实验思路与总结</a>
  - <a href="#6.3.1">初始方案</a>
  - <a href="#6.3.2">DEBUG 过程</a>
    - <a href="#6.3.2.1">`mm_free` 中忘记接住合并函数 `_coalesce` 的返回值</a>
    - <a href="#6.3.2.2">放置函数 `_place` 中对不分割的情况的处理存在错误</a>
    - <a href="#6.3.2.3">忘记在检查程序 `mm_check` 中释放内存</a>
  - <a href="#6.3.3">优化</a>
    - <a href="#6.3.3.1">测试样例 `binary-bal.rep` 和 `binary2-bal.rep` 的内存利用率过低</a>
  - <a href="#6.3.4">实现 `mm_realloc`</a>
- <a href="#6.4">相关资料</a>
...
#### <a id="6.3.1"></a>实现 `mm_malloc` 和 `mm_free`

[待办]

#### <a id="6.3.2"></a>DEBUG

##### <a id="6.3.2.1"></a>`mm_free` 中忘记接住合并函数 `_coalesce` 的返回值
...
##### <a id="6.3.2.2"></a>放置函数 `_place` 中对不分割的情况的处理存在错误
...
##### <a id="6.3.2.3"></a>忘记在检查程序 `mm_check` 中释放内存
...
#### <a id="6.3.3"></a>优化 `mm_malloc` 和 `mm_free`

##### <a id="6.3.3.1"></a>测试样例 `binary-bal.rep` 和 `binary2-bal.rep` 的内存利用率过低
