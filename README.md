...
- <a href="#1">注意事项</a><a href="#1"></a>
- <a href="#2">1. Data Lab</a><a href="#2"></a>
  - <a href="#2.1">目标</a><a href="#2.1"></a>
  - <a href="#2.2">概览</a><a href="#2.2"></a>
    - <a href="#2.2.1">整数 puzzle</a><a href="#2.2.1"></a>
    - <a href="#2.2.2">浮点数 puzzle</a><a href="#2.2.2"></a>
    - <a href="#2.2.3">`btest` - 正确性检查工具</a><a href="#2.2.3"></a>
    - <a href="#2.2.4">`dlc` - 合法性检查工具</a><a href="#2.2.4"></a>
    - <a href="#2.2.5">`driver.pl` - 最终评分工具</a><a href="#2.2.5"></a>
    - <a href="#2.2.6">其他</a><a href="#2.2.6"></a>
  - <a href="#2.3">思路与总结</a><a href="#2.3"></a>
    - <a href="#2.3.1">#01 `bitXor` - 使用 `~` 和 `&` 实现 `^`</a><a href="#2.3.1"></a>
    - <a href="#2.3.2">#02 `tmin` - 返回 </a>$TMin_w$<a href="#2.3.2"> [TODO]</a><a href="#2.3.2"></a>
    - <a href="#2.3.3">#03 `isTmax` - 判断是否为 </a>$TMax_w$<a href="#2.3.3"></a>
    - <a href="#2.3.4">#04 `allOddBits` - 判断一个二进制模式的所有奇数位是否均为 1</a><a href="#2.3.4"></a>
    - <a href="#2.3.5">#05 `negate` - 返回一个补码整数的相反数</a><a href="#2.3.5"></a>
    - <a href="#2.3.6">#06 `isAsciiDigit` [TODO]</a><a href="#2.3.6"></a>
    - <a href="#2.3.7">#07 `conditional` [TODO]</a><a href="#2.3.7"></a>
    - <a href="#2.3.8">#08 `isLessOrEqual` [TODO]</a><a href="#2.3.8"></a>
    - <a href="#2.3.9">#09 `logicalNeg` [TODO]</a><a href="#2.3.9"></a>
    - <a href="#2.3.10">#10 `howManyBits` [TODO]</a><a href="#2.3.10"></a>
    - <a href="#2.3.11">#11 `floatScale2` [TODO]</a><a href="#2.3.11"></a>
    - <a href="#2.3.12">#12 `floatFloat2Int` [TODO]</a><a href="#2.3.12"></a>
    - <a href="#2.3.13">#13 `floatPower2` [TODO]</a><a href="#2.3.13"></a>
  - <a href="#2.4">相关资料</a><a href="#2.4"></a>
    - <a href="#2.4.1">命题逻辑</a><a href="#2.4.1"></a>
- <a href="#3">2. Bomb Lab</a><a href="#3"></a>
  - <a href="#3.1">目标</a><a href="#3.1"></a>
  - <a href="#3.2">概览</a><a href="#3.2"></a>
    - <a href="#3.2.1">`bomb.c` - 框架描述</a><a href="#3.2.1"></a>
    - <a href="#3.2.2">`bomb` - 主体</a><a href="#3.2.2"></a>
  - <a href="#3.3">思路与总结</a><a href="#3.3"></a>
    - <a href="#3.3.1">`sig_handler`</a><a href="#3.3.1"></a>
    - <a href="#3.3.2">`initialize_bomb`</a><a href="#3.3.2"></a>
    - <a href="#3.3.3">`string_length`</a><a href="#3.3.3"></a>
    - <a href="#3.3.4">`strings_not_equal`</a><a href="#3.3.4"></a>
    - <a href="#3.3.5">`explode_bomb`</a><a href="#3.3.5"></a>
    - <a href="#3.3.6">`phase_defused`</a><a href="#3.3.6"></a>
    - <a href="#3.3.7">`read_six_numbers`</a><a href="#3.3.7"></a>
    - <a href="#3.3.8">`func4`</a><a href="#3.3.8"></a>
    - <a href="#3.3.9">`fun7`</a><a href="#3.3.9"></a>
    - <a href="#3.3.10">`phase_1`</a><a href="#3.3.10"></a>
    - <a href="#3.3.11">`phase_2`</a><a href="#3.3.11"></a>
    - <a href="#3.3.12">`phase_3`</a><a href="#3.3.12"></a>
    - <a href="#3.3.13">`phase_4`</a><a href="#3.3.13"></a>
    - <a href="#3.3.14">`phase_5`</a><a href="#3.3.14"></a>
    - <a href="#3.3.15">`phase_6`</a><a href="#3.3.15"></a>
    - <a href="#3.3.16">`secret_phase`</a><a href="#3.3.16"></a>
  - <a href="#3.4">相关资料</a><a href="#3.4"></a>
    - <a href="#3.4.1">GDB</a><a href="#3.4.1"></a>
    - <a href="#3.4.2">Linux 命令</a><a href="#3.4.2"></a>
- <a href="#4">3. Attack Lab</a><a href="#4"></a>
...
#### <a id="2.3.1"></a>#01 `bitXor` - 使用 `~` 和 `&` 实现 `^`
...
#### <a id="2.3.2"></a>#02 `tmin` - 返回 $TMin_w$ [TODO]
...
#### <a id="2.3.3"></a>#03 `isTmax` - 判断是否为 $TMax_w$
...
#### <a id="2.3.4"></a>#04 `allOddBits` - 判断一个二进制模式的所有奇数位是否均为 1
...
#### <a id="2.3.5"></a>#05 `negate` - 返回一个补码整数的相反数

最终实现为取反加一, 原理待补充.

#### <a id="2.3.6"></a>#06 `isAsciiDigit` [TODO]

通过将两个模式相减并检查结果是否为负数来实现比较运算.

#### <a id="2.3.7"></a>#07 `conditional` [TODO]

首先判断是否为零, 若为零则选择全 0 模式, 否则取反得到全 1 模式; 再使用按位与 `&` 进行条件选择.

#### <a id="2.3.8"></a>#08 `isLessOrEqual` [TODO]

先检查两个数是否同号, 若同号则通过相减是否得到负数进行判断, 若异号直接检查哪一个数为正哪一个数为负即可.

#### <a id="2.3.9"></a>#09 `logicalNeg` [TODO]

逻辑非等价于检查取反后的结果是否为全 0.

#### <a id="2.3.10"></a>#10 `howManyBits` [TODO]
